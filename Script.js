// အစားအသောက် ဒေတာများ (မြန်မာ/အင်္ဂလိပ်)
const foodData = {
    underweight: [
...
function calculateBMI() {
    ...
    const h = document.getElementById('height').value / 100; // cm to meters
    ...
    if (w > 0 && h > 0) {
        ...
        if (bmi < 18.5) {
            ...
            status = currentLang === 'my' ? `BMI: ${bmi} (ပုံမှန်)` : `BMI: ${bmi} (Normal)`;
        } else {
